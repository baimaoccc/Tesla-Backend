 ...
 * @icon fa fa-circle-o
 */
class Serviceuser extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\FastChatServiceUser;
        $this->view->assign("addSessiondataList", $this->model->getAddSessiondataList());
